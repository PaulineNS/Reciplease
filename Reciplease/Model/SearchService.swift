...
final class SearchService: MapperEncoder {
    ...
    init(session: RequestSession = SearchSession()) {
    ...
    func getRecipes(ingredients: String, health: String, callback: @escaping (Result<Recipe, Error>) -> Void) {
        ...
        let url = encode(baseUrl: baseURL, parameters: [("q", ingredients + health),("to", "30"),("app_id","e6b49d48"),("app_key","c2809da35956f6fb80d5a86c46199b6b")])
